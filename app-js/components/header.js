const Header =() => {
    ...
    const $iconDarkModeBox = document.createElement('article')
    ...
    $iconDarkModeBox.appendChild($iconSun)
    $iconDarkModeBox.appendChild($iconMoon)
    $DarkMode.appendChild($iconDarkModeBox)
